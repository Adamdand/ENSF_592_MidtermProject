...
#mongodb+srv://adamdand:Family590274003?@cluster0.bx1n3.mongodb.net/<dbname>?retryWrites=true&w=majority
...
def print_map(frame_display,collection_name):
    ...
    for index, row in df.iterrows():
        folium.Marker(location=[row['Latitude'], row['Longitude']], popup=str(row['frequency']),icon=folium.Icon(color='red',icon='location')).add_to(map_osm)
   
    #saves the map in the directory
    map_osm
    map_osm.save('C:/Users/adamd/Desktop/ENSF592/Project2/map.html')
